                    ...
                    <div style="align: center">
                    	...
                    	<form action="CreateAccount" method="post">
							...
							<div class="d-flex align-items-center justify-content-center" >
								<button style = "border-color: #ffca3d; background-color: #ffca3d; color: #020c53" type="submit" class="btn btn-primary">Sign Up</button>
							</div>
  							<!-- Register buttons -->
  							<div class="text-center">
   								<p>Have an account? <a href="LoginPage">Login instead</a></p>
  							</div>
    					</form>
					</div>
                </div>
